...
$data_tbl = getdata("SELECT * FROM tb_user");
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            <?php foreach ($data_tbl  as $data) :  ?>
                                <tr>
                                    <td>
                                        <a href="hapusUser.php?id=<?php echo $data["id_user"]; ?>" style="text-decoration: none;"><img src="images/remove.svg" alt="" class="gambar"> </a> |
                                        <a href="editUser.php?id=<?php echo $data["id_user"]; ?>" style="text-decoration: none;"><img src="images/edit.svg" alt="" class="gambar"></a>
